...
function () {
  ...
  _createClass(Constructor, [{
    ...
    value: function events() {
      var self = this;
      var dimension = self.SettaPosizioniTessere();
      ...
      $(".drop").droppable({
        ...
        drop: function drop(event, ui) {
          ...
          var res = ObjBracciale.filter(function (item) {
            return item.position != j;
          });
          res.push({
            idx: j,
            position: j,
    ...
    value: function SettaPosizioniTessere() {
      return {
        tes_top: 4,
        tes_left: 5,
        tes_top1: 4,
    ...
    key: "RimuoviTessera",
    value: function RimuoviTessera(id) {
      var self = this;
      var j = $(id).attr('nrbase');
      ObjBracciale = ObjBracciale.filter(function (item) {
        return item.position != j;
      });
    ...
    key: "SortObjBracciale",
    value: function SortObjBracciale() {
      var res = ObjBracciale.map(function (item) {
        var idx = $(document).find("#base_".concat(item.idx)).index();
        return _objectSpread({}, item, {
          position: idx
        });
      });
      ObjBracciale = Object(lodash["orderBy"])(res, 'position', 'asc'); // $('#bracciale .tessera_base').each(function(index) {
